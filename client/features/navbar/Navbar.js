        ...
        {isLoggedIn ? (
          ...
          <div id="nav-container" >
            ...
            <div className="dropdown bg-black">    
              <button className="bg-black"  >Dropdown</button>
              <div className="dropdown-content">
              <a href="#" className="text-gray-700">Movies</a>
                <a href="#">TV Shows</a>
                <a href="#">Awards & Events</a>
              </div>
...
<button className="btn gap-2">
  ...
  <div className="badge badge-secondary">+99</div>
            ...
            <input className="search bg-black box-border caro" type="text" placeholder="Search.."></input>
            <Link to="/login" className="text-blue-600 btn" >Login</Link>
      ...
      <hr />
      <button className="btn btn-secondary">hfffi</button>
